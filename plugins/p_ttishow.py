    ...
    if temp.ME in r_j_check:
        ...
        for u in message.new_chat_members:
                ...
                temp.MELCOW['welcome'] = await message.reply(f"<b>Hey , {u.mention}, Welcome to {message.chat.title}</b>",
                                                             reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("close", callback_data="close_data"),InlineKeyboardButton("close", callback_data="close_data"),InlineKeyboardButton("close", callback_data="close_data"),InlineKeyboardButton("close", callback_data="close_data")]]))                                                  
